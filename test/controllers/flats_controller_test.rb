...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference('Flat.count') do
      post flats_url, params: { flat: { address: @flat.address, description: @flat.description, host_id: @flat.host_id, lat: @flat.lat, long: @flat.long, name: @flat.name, photo: @flat.photo } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { address: @flat.address, description: @flat.description, host_id: @flat.host_id, lat: @flat.lat, long: @flat.long, name: @flat.name, photo: @flat.photo } }
